...
struct RuntimeProfileReport {
    ...
    uint64_t workerInputMessagesTooLarge = 0;
    uint64_t workerInputQueueFull = 0;
    uint64_t workerOutputMessagesTooLarge = 0;
    uint64_t workerOutputQueueFull = 0;
    ...
    uint64_t workerLargestInputMessageBytes = 0;
    uint64_t workerLargestOutputMessageBytes = 0;
